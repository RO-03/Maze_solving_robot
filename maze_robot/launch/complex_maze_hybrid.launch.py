...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package=pkg_name, executable='hybrid_algorithm_node', output='screen',
             parameters=[{'goal_x': 0.0, 'goal_y': 8.0, 'use_sim_time': True}]),
        Node(package=pkg_name, executable='logger_node', output='screen',
             parameters=[{'maze_name': 'complex', 'use_sim_time': True}]),
